...
SECRET_KEY = 'django-insecure-i781(n!*p#j32tynh&%^8=&&zm)l@0==+=yp36%9ffhq+!+c$m'
...
TEMPLATES = [
    {
        ...
        'libraries':{
            ...
            'favoritesTag': 'buyers.templatetags.favoritesTag',
            'productInCartTag': 'buyers.templatetags.productInCartTag',
            }
        },
    },
]
